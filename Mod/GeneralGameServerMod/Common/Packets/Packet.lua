...
local PacketTypes = commonlib.gettable("Mod.GeneralGameServerMod.Common.Packets.Packet");
-------------------------------------------------------
]]
...
local Packet = commonlib.inherit(commonlib.gettable("MyCompany.Aries.Game.Network.Packets.Packet"), commonlib.gettable("Mod.GeneralGameServerMod.Common.Packets.Packet"));
