...
-- 绘制输入语句
function Shape:DrawInputStatement(painter, leftUnitCount, topUnitCount, widthUnitCount, heightUnitCount, offsetXUnitCount, offsetYUnitCount)
    local UnitSize = self:GetUnitSize();
    self:DrawBefore(painter, offsetXUnitCount, offsetYUnitCount);
    painter:DrawRectTexture(leftUnitCount * UnitSize, topUnitCount * UnitSize, widthUnitCount * UnitSize, heightUnitCount * UnitSize, self:GetInputStatementTexture());
    self:DrawAfter(painter, offsetXUnitCount, offsetYUnitCount);
end
