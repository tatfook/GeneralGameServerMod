...
Options.playMusicFileTypes = function()
    return {
        ...
        {"音频主题", "Audio/cAudioTheme1.ogg"},
        -- {"游戏背景乐1", "Audio/Haqi/OldFiles/game_bg1.wav"},
        -- {"游戏背景乐2", "Audio/Haqi/OldFiles/game_bg2.wav"},
        -- {"游戏背景乐3", "Audio/Haqi/OldFiles/game_bg3.wav"},
        -- {"马里奥", "Audio/Haqi/OldFiles/Mario.wav"},
        -- {"马里奥低音", "Audio/Haqi/OldFiles/MarioLow.wav"},
        -- {"MIDI", "Audio/Haqi/OldFiles/MIDI01.WAV"},
        -- {"任务完成", "Audio/Haqi/OldFiles/MissionComplete.wav"},
        -- {"音乐盒1", "Audio/Haqi/OldFiles/MusicBox1.wav"},
        -- {"音乐盒2", "Audio/Haqi/OldFiles/MusicBox2.wav"},
        -- {"音乐盒3", "Audio/Haqi/OldFiles/MusicBox3.wav"},
        -- {"创建植物", "Audio/Haqi/OldFiles/plant_create.wav"},
        -- {"水马", "Audio/Haqi/OldFiles/Region_AquaHorse.wav"},
        -- {"蜜蜂", "Audio/Haqi/OldFiles/Region_Bee.wav"},
        -- {"嘉年华2", "Audio/Haqi/OldFiles/Region_Carnival.wav"},
        -- {"龙森林", "Audio/Haqi/OldFiles/Region_DragonForest.wav"},
        -- {"火洞2", "Audio/Haqi/OldFiles/Region_FireCavern.wav"},
        -- {"跳跳农场", "Audio/Haqi/OldFiles/Region_JumpJumpFarm.wav"},
        -- {"春天生活", "Audio/Haqi/OldFiles/Region_LifeSpring.wav"},
        -- {"魔法森林", "Audio/Haqi/OldFiles/Region_MagicForest.wav"},
        -- {"阳光海滩2", "Audio/Haqi/OldFiles/Region_SunnyBeach.wav"},
        -- {"城镇广场", "Audio/Haqi/OldFiles/Region_TownSquare.wav"},
        -- {"RICH08", "Audio/Kids/sound collections/RICH08.WAV"},
        -- {"RICH16", "Audio/Kids/sound collections/RICH16.WAV"},
        -- {"RICH17", "Audio/Kids/sound collections/RICH17.WAV"},
        -- {"RICH18", "Audio/Kids/sound collections/RICH18.WAV"},
        -- {"RICH19", "Audio/Kids/sound collections/RICH19.WAV"},
        -- {"RICH20", "Audio/Kids/sound collections/RICH20.WAV"},
        -- {"RICH21", "Audio/Kids/sound collections/RICH21.WAV"},
        -- {"科技舞曲", "Audio/Kids/sound collections/Techno_1.wav"},
