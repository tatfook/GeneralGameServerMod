...
local BlockManager = commonlib.gettable("GeneralGameServerMod.Server.BlockManager");

-------------------------------------------------------
]]

-- 对象定义
local BlockManager = commonlib.inherit(nil, commonlib.gettable("Mod.GeneralGameServerMod.Server.BlockManager"));
